...
public class TalkManager : MonoBehaviour
{
    ...
    public void SetData()
    {
        ...
        tutorialData.Add(2, "기본공격 - Ctrl, 회피 기술 - Space Bar");
        tutorialData.Add(3, "화살표를 따라 위에 있는 파란색 원으로 이동하세요");
        tutorialData.Add(4, "앞에 보이는 쥐를 공격해보세요");
        tutorialData.Add(5, "다음 층으로 보내드리겠습니다.");
    }
